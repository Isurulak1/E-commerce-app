...
const Add = () => {
  return (
    <form className='flex flex-col w-full items-start gap-3 px-10'>
      <div>
      ...
      <div className='w-full'>
        ...
        <textarea className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Write Conten Here' required/>
      </div>
